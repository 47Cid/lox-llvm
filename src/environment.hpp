...
class Environment {
   public:
    ...
    Environment(llvm::Function* Function, llvm::BasicBlock* ExitBlock, std::unique_ptr<Environment> EnclosingEnv) : Function(Function), ExitBlock(ExitBlock), EnclosingEnv(std::move(EnclosingEnv)) {}
