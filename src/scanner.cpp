...
Scanner::Scanner(const std::string &&Src) : Source(std::move(Src)) {
  ...
  Keywords.insert(std::pair<std::string, TokenType>("nil", TOK_NIL));
  Keywords.insert(std::pair<std::string, TokenType>("return", TOK_RETURN));
  Keywords.insert(std::pair<std::string, TokenType>("true", TOK_TRUE));
  Keywords.insert(std::pair<std::string, TokenType>("false", TOK_FALSE));
  Keywords.insert(std::pair<std::string, TokenType>("or", TOK_OR));
  Keywords.insert(std::pair<std::string, TokenType>("and", TOK_AND));
